(ns ledgerx-clj.authentication-test
  (:require [clojure.test :refer :all]
            [ledgerx-clj.authentication :refer :all]))

(deftest create-prehash-string-test
  (is (= "123GET/time"
         (#'ledgerx-clj.authentication/create-prehash-string
          123
...
(deftest create-http-signature-test
  (is (= "feI9Pm5uupzIiDq9p80pL1/z36vwBwIlVrSiXwa14k4="
         (#'ledgerx-clj.authentication/create-http-signature
          "aGVsbG8="
          123
          {:method "POST" :url "https://api.gdax.com/orders" :body {:hello "world"}}))
      "with request body")
...
(deftest create-websocket-signature-test
  (is (= "C1DZ6pZxgL7VxLvMCCs+8XRCC+lZjYHa1NsATV8kbLc="
         (#'ledgerx-clj.authentication/create-websocket-signature
          "aGVsbG8="
          123))))

(deftest sign-request-test
  (with-redefs [ledgerx-clj.utilities/get-timestamp (constantly 123)]
    (is (= {:method "GET"
